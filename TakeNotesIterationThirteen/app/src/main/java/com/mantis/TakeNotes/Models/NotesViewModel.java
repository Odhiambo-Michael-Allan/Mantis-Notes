...
public class NotesViewModel extends ViewModel {
    ...
    private MutableLiveData<List<Note>> observableHomeFragmentNotes = new MutableLiveData<>(),
            observableFrequentFragmentNotes = new MutableLiveData<>(),
            observableArchiveFragmentNotes = new MutableLiveData<>(),
            observableTrashFragmentNotes = new MutableLiveData<>();
