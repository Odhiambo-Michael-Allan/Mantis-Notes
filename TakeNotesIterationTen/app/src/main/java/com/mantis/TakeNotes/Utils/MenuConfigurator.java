...
public class MenuConfigurator {
    ...
    private static void checkGridOption( SubMenu viewOptionSubMenu ) {
        ...
        viewOptionSubMenu.findItem( R.id.grid_option ).getIcon().setTint(Color.parseColor( "#797979"));
        SpannableString s = new SpannableString( "Grid" );
        s.setSpan( new ForegroundColorSpan( Color.parseColor( "#797979" ) ), 0, s.length(), 0 );
    ...
    private static void checkListOption( SubMenu viewOptionSubMenu ) {
        ...
        viewOptionSubMenu.findItem( R.id.list_option ).getIcon().setTint( Color.parseColor( "#797979" ) );
    ...
    private static void checkSimpleListOption( SubMenu viewOptionSubMenu ) {
        ...
        viewOptionSubMenu.findItem( R.id.simple_list_option ).getIcon().setTint( Color.parseColor( "#797979" ) );
