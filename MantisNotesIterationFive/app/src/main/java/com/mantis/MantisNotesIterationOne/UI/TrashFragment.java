...
public class TrashFragment extends Fragment {
    ...
    private void setupRecyclerView() {
        ...
        adapter.setData( new ArrayList<>(), binding.trashFragmentContent.trashFragmentAppBarLayout.toolbar.getMenu() );
        ...
        notesViewModel.getDeletedNotes().observe( getViewLifecycleOwner(),
                new Observer<ArrayList<Note>>() {
                    ...
                    public void onChanged( ArrayList<Note> notes ) {
                        adapter.setData( notes, binding.trashFragmentContent.trashFragmentAppBarLayout.toolbar.getMenu() );
                    }
                } );
