        ...
        notesAdapter.addListener( new NotesAdapter.NoteAdapterListener() {
            ...
            public void onViewHolderClicked( View view, int viewHolderPosition ) {
                HomeFragmentDirections.ActionNavHomeToNavAddNote action =
                        HomeFragmentDirections.actionNavHomeToNavAddNote( viewHolderPosition,
            ...
            public void onViewHolderLongClicked( int viewHolderPosition ) {
                ...
                actionDialog.addListener(new NoteActionDialog.NoteActionDialogListener() {
                    ...
                    public void deleteSelected() {
                        notesViewModel.trashNoteFromNotesListAtPosition( viewHolderPosition );
                    }
    ...
    private void observeNotes() {
        notesViewModel.getNotes().observe( getViewLifecycleOwner(), new Observer<ArrayList<Note>>() {
            ...
            public void onChanged( ArrayList<Note> notes ) {
                ...
                notesAdapter.setData( notes, binding.homeFragmentContent.appBarLayout.toolbar.getMenu() );
            }
        } );
    }
