...
public class FakeDataSource implements NoteDataSource {
    ...
    private MutableLiveData<List<NoteReference>> observableHomeNotesReferenceTable
            = new MutableLiveData<>();
    private ArrayList<NoteReference> frequentNotesReferenceTable = new ArrayList<>();
    private MutableLiveData<List<NoteReference>> observableFrequentNotesReferenceTable
            = new MutableLiveData<>();
    private ArrayList<NoteReference> archiveNotesReferenceTable = new ArrayList<>();
    private MutableLiveData<List<NoteReference>> observableArchiveNotesReferenceTable
            = new MutableLiveData<>();
    private ArrayList<NoteReference> trashNotesReferenceTable = new ArrayList<>();
    private MutableLiveData<List<NoteReference>> observableTrashNotesReferenceTable
            = new MutableLiveData<>();
